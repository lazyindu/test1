...
async def youtube_dl_call_back(client, query):
    ...
    try:
        ...
        await query.message.reply_sticker(sticker=random.choice(lazystickerset))
    except Exception as e:
        await xLAZY_BAAPUx_init.edit(e)
